...
| Profile | aligned to the MoMorph render (screenId `3FoIx6ALVb`): sent/received are 5-card personal slices (design "Đã gửi (5)"), kudos column 680px matching the stats box, Spam ribbon orange |
...
Out of scope: /dashboard (no design counterpart; /kudos and /profile aligned against MoMorph renders instead).
